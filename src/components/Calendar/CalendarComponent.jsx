...
const CalendarComponent = ({ incidents }) => {
    ...
    return (
        <div className="h-full flex flex-col bg-white dark:bg-gray-800">
            ...
            {/* Calendar + Sidebar */}
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6 p-4 sm:p-6 flex-1 overflow-hidden">
                {/* Calendar Grid */}
                                ...
                                >
                                    ...
                                    {dayIncidents.length > 0 && (
                                        <div className="absolute bottom-1 left-1/2 transform -translate-x-1/2">
                                            <div className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full transition-all duration-300 ${isSelected || isHovered
                ...
                <div className="xl:col-span-1">
                    <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 transition-all duration-300 h-full overflow-y-auto">
                                ...
                                {displayIncidents.length === 0 ? (
                                    ...
                                    displayIncidents.map((incident, index) => {
                                        ...
                                        return (
                                            <div
                                                key={incident.id}
                                                className="bg-white dark:bg-gray-600 p-3 rounded-md shadow-sm transition-all duration-300 transform hover:scale-105 hover:shadow-md animate-fade-in-up"
